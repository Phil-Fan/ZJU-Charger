...
class Config:
    ...
    # 数据抓取配置
    FETCH_INTERVAL = int(os.getenv("FETCH_INTERVAL", "60"))  # 前端自动刷新间隔（秒），默认60秒
    BACKEND_FETCH_INTERVAL = int(os.getenv("BACKEND_FETCH_INTERVAL", "300"))  # 后端定时抓取间隔（秒），默认300秒（5分钟）
    ...
    @classmethod
    def get_provider_config_value(cls, provider_id: str, config_key: str, default: Optional[str] = None) -> Optional[str]:
        """获取指定服务商的特定配置值
